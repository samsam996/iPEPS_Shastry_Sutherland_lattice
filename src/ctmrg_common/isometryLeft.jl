...
function isometryLeft(C,T,tens,gt::Matrix{Symbol},i::Int64,j::Int64,chi::Int64)
    ...
    # u,s,v = svd(Q2tilde,(cya',yb'), maxdim = chi)#, SVDMethod = "gesdd",cutoff = 1e-10);
